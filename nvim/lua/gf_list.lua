...
--- @return GfList: A list with elements between a and b
...
--- @return GfList: A slice from 1 to #self, i.e., a complete copy of the list
--- @see List.deep_copy
function List:copy()
...
--- @return GfList: A deep copy of the object
--- @see List.copy
--- @see vim.deep_copy
...
--- </pre>
--- @return GfList: The list itself, so you can chain method calls
--- @see List.copy
--- @see List.deep_copy
...
--- given arguments
--- @vararg table|GfList: The sequences to concatenate to this one
--- @return GfList
...
--- @param other table|GfList: The destination list. Defaults to self
--- @see table.move
...
--- @return GfList: a list containing all the given elements
--- @see table.pack
function List.pack(...)
  return List.new { ... }
end
